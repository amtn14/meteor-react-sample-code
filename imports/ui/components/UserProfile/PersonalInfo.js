...
class PersonalInfo extends React.Component {
    ...
    handleGmapsAutoCompleteInput(selectedObj) {
        let addressObj = {
            city: (selectedObj.gmaps.address_components && selectedObj.gmaps.address_components[0]) ? selectedObj.gmaps.address_components[0].long_name : "",
            state: (selectedObj.gmaps.address_components && selectedObj.gmaps.address_components[2]) ? selectedObj.gmaps.address_components[2].long_name : "",
            timezoneId: null
        };
        ...
        Meteor.call('utility.getTimezone', selectedObj.location.lat, selectedObj.location.lng, (error, response) => {
            if (error) {
                console.log("something went wrong in getting the timezone", error);
            } else {
