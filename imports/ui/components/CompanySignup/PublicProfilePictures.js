        ...
        return (
            <div>
                        ...
                        <Row>
                            ...
                            <Col sm={12}>
                                <div className="button-container">
                                    <Button className="go-to-next-step-btn btn-bg-orange btn-fat btn-wide btn" type="submit">{this.props.isOnSignupView ? "Complete Signup" : "Save"}</Button>
                                </div>
                            </Col>
                        </Row>
                    </form>
                ...
                <Modal className="company-image-cropper-modal"
                    ...
                    <Modal.Footer>
                        <Button className="btn-bg-purple" onClick={ () => this.handleModalActions("save") }>CROP</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
