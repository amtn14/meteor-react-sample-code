        ...
        return (
            <div>
                        ...
                        <Row>
                            ...
                            <Col sm={12}>
                                    ...
                                    <div className="button-container">
                                        <Col sm={6}>
                                            <div className="button-container">
                                                <Button
                                                    type="button"
                                                    className="btn-bg-dark-gray btn-fat btn-wide btn"
                                        ...
                                        <Col sm={6}>
                                            <div className="button-container">
                                                <Button className="go-to-next-step-btn btn-bg-orange btn-fat btn-wide btn"
                                ...
                                :
                                    <div className="button-container">
                                        <Button
                                            className="go-to-next-step-btn btn-bg-orange btn-fat btn-wide btn"
                                            type="submit">Save
                                        </Button>
                                    </div>
                                }
                ...
                <Modal className="company-image-cropper-modal"
                    ...
                    <Modal.Footer>
                        <Button className="btn-bg-purple btn-fat btn-wide" onClick={ () => this.handleModalActions("save") }>CROP</Button>
                    </Modal.Footer>
                </Modal>
            </div>
        )
