...
Employees.schema = new SimpleSchema({
    ...
    'completedSignUpSteps.$': {
        ...
        //todo-ky implement during usersignup clean refactor
        //allowedValues: Roles.userIsInRole(Meteor.user(), userRoles.companyAdmin) ? Object.keys(companySignupEnums).map(function(k){ return parseInt(companySignupEnums[k].enum)}) : Object.keys(employeeSignupEnums).map(function(k){ return parseInt(employeeSignupEnums[k].enum)}),
    },
    createdAt: {
        type: Date,
        autoValue() {
